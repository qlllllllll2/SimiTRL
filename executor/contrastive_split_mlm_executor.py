...
class ContrastiveSplitMLMExecutor(ContrastiveMLMExecutor):
    ...
    def _train_epoch(self, train_dataloader, epoch_idx):
        ...
        for i, batch in tqdm(enumerate(train_dataloader), desc="Train epoch={}".format(
            ...
            contra_view1, contra_view2, padding_masks1, padding_masks2, batch_temporal_mat1, batch_temporal_mat2, simi_contra_view1, simi_contra_view2, simi_batch_temporal_mat1, simi_batch_temporal_mat2, simi_padding_masks1, simi_padding_masks2, \
            ...
            simi_contra_view1 = simi_contra_view1.to(self.device)
            simi_contra_view2 = simi_contra_view2.to(self.device)
            simi_padding_masks1 = simi_padding_masks1.to(self.device)
            simi_padding_masks2 = simi_padding_masks2.to(self.device)
            simi_batch_temporal_mat1 = simi_batch_temporal_mat1.to(self.device)
            simi_batch_temporal_mat2 = simi_batch_temporal_mat2.to(self.device)
            X = X.to(self.device)
